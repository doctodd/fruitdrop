...
function create() {
    ...
    ground.setPosition(0 + ground.centerOfMass.x, 310 + ground.centerOfMass.y);  // corrected position: (0,280)
    ...
    this.input.on('pointerdown', function (pointer) {
        this.matter.add.sprite(pointer.x, pointer.y, 'sheet', 'crate', {shape: shapes.crate});
    }, this);
}
